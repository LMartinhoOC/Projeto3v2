...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "API Projeto3", Version = "v1" });
...
builder.Services.AddScoped<IFilmesPersistence, FilmesPersistence>();
